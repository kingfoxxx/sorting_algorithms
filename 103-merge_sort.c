...
/**
 * copy - copies data from one buffers to another
 *
 * @src: source buffer
 * @dst: destination buffers
...
/**
 * printcheck - prints an array in a given range of file
 *
 ...
 *
 * @array: array of data to be sorted in file
